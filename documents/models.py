...
class Document(models.Model):
    ...
    price_value = models.IntegerField() #'max_length' is ignored when used with IntegerField
...
class Copy(models.Model):
    ...
    hash_number = models.IntegerField() #'max_length' is ignored when used with IntegerField
...
class Book(Document):
    edition = models.IntegerField() #'max_length' is ignored when used with IntegerField
    pass
